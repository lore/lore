...
This file specifies which project files should be kept out of version control if you are using git. It includes things
like code coverage reports, npm installation error files, your config/local.js file, IDE specific files and more.
...
# be ignored by git.  This keeps random files and
