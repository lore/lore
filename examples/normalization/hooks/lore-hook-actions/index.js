...
module.exports = {
  ...
  defaults: {
    actions: {
      ...
      blueprints: {
        create: require('lore-hook-actions/lib/blueprints/create'),
        destroy: require('lore-hook-actions/lib/blueprints/destroy'),
        get: require('lore-hook-actions/lib/blueprints/get'),
        find: require('lore-hook-actions/lib/blueprints/find'),
        update: require('lore-hook-actions/lib/blueprints/update')
      }
    }
  },
