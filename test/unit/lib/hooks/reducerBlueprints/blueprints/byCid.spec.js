...
var byCid = require('../../../../../../lib/hooks/reducerBlueprints/blueprints/byCid');
var ActionTypes = require('../../../../../../lib/utils/ActionTypes');


describe('hooks#reducerBlueprints#blueprints#byCid', function() {
  var modelName = 'todo';
  var blueprint = byCid;
  var reducer = null;
