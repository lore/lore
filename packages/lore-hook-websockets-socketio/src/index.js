...
var SocketIoWebSocketConnection = require('./SocketIoWebSocketConnection');
...
module.exports = {
  ...
  load: function(lore) {
    ...
    Object.keys(models).forEach(function(modelName) {
      ...
      var CustomSocketIoWebSocketConnection = SocketIoWebSocketConnection.extend(_.extend(conventions, config));
