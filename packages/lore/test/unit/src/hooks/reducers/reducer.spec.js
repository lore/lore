...
var blueprints = {
  find: require('../../../../../src/hooks/reducers/blueprints/find'),
  byId: require('../../../../../src/hooks/reducers/blueprints/byId'),
  byCid: require('../../../../../src/hooks/reducers/blueprints/byCid')
};
var blueprint = require('../../../../../src/hooks/reducers/reducer');
var ActionTypes = require('../../../../../src/utils/ActionTypes');
var Hook = require('../../../../../src/Hook');

describe('hooks#reducerBlueprints#reducer', function() {
  var modelName = 'todo';
  var reducer = null;
